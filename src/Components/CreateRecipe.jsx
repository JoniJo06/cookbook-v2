				...
				<Container>
					<form onSubmit={handleSubmit}>
						<Stack spacing={5} justifyContent='center'>
							<TextField onChange={handleChange} className='text' color='secondary' required id='title' label='Titel' value={values[0].value} />
							...
							/>
							<TextField onChange={handleChange} color='secondary' required multiline id='instructions' label='Zubereitung' value={values[2].value} />
							<TextField
								onChange={handleChange}
								color='secondary'
								required
							...
							/>
							<TextField onChange={handleChange} color='secondary' id='picture_two_alt' label='Beschreibung Bild 2' value={values[8].value} />
						</Stack>
						<Button style={{ margin: '2em 0' }} variant='contained' type='submit' fullWidth size='large'>
							Rezept hinzufügen
						</Button>
					</form>
				</Container>
